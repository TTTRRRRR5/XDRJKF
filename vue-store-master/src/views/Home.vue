...
<!--          <img style="height:460px;" :src="item.imgPath" :alt="item.describes" />-->
          <img src="../assets/imgs/cms_1.jpg" alt />
        </el-carousel-item>
      </el-carousel>
    </div>
    <!-- 轮播图END -->
...
export default {
  ...
  created() {
   ...
   //    });
    this.carousel=[{carousel_id:1,imgPath:"../assets/imgs/logo.png"},{carousel_id:2,imgPath:"https://pics4.baidu.com/feed/d1160924ab18972b6c071605639efb849f510aa4.jpeg@f_auto?token=8a1efcf6060cb3b7785b3de3ee081f82"}]
    // 获取各类商品数据
